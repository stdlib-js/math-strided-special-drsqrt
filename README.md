...
```javascript
import drsqrt from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-drsqrt@esm/index.mjs';
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-strided-special-drsqrt/tags). For example,

```javascript
import drsqrt from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-drsqrt@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-strided-special-drsqrt/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/math-strided-special-drsqrt/actions/workflows/test.yml?query=branch:v0.2.2
...
[deno-readme]: https://github.com/stdlib-js/math-strided-special-drsqrt/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/math-strided-special-drsqrt/tree/umd
[umd-readme]: https://github.com/stdlib-js/math-strided-special-drsqrt/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/math-strided-special-drsqrt/tree/esm
[esm-readme]: https://github.com/stdlib-js/math-strided-special-drsqrt/blob/esm/README.md
